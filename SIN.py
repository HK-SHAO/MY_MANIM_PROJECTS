...
class A(Scene):
    def construct(self):
        ...
        tex8 = TexMobject("x={-b \\pm \\sqrt{b^2-4ac} \\over 2a}").to_corner(DOWN)
        ...
        self.play(ReplacementTransform(tex8, tex7), ReplacementTransform(tipt7, tipt8))
...
class B(Scene):
    def construct(self):
        ...
        tex9 = TexMobject("{\\rm Ln}(e^{ix})", "=", "{\\rm Ln}[(2\\pm\\sqrt3)i]")
        ...
        self.play(FadeOut(tex9[0][0:4]),
                    ...
                    ReplacementTransform(VGroup(tex9[2][2], tex9[2][11]), tex10[0][-4]),
                    ReplacementTransform(tipt10, tipt11))
        self.wait()
        self.play(FadeOut(g1), FadeOut(tipt11), FadeOut(tex4), tex10.to_corner, UP)
        self.clear()
        ...
        self.wait()
        self.wait()
        text2 = TextMobject("令\\ $i\\theta={\\rm Ln}\\ i$\\\\利用欧拉公式\\ $e^{i\\theta}=\\cos \\theta+i\\sin \\theta$\\\\可以得到")
        ...
        tex6 = TexMobject("{\\rm Ln}\\ i=i\\theta=i(\\frac{4k+1}{2})\\pi").set_color(YELLOW)
        ...
        self.clear()
        tex7 = TexMobject("ix", "=", "\\ln(2\\pm\\sqrt3)", "+", "i(\\frac{4k+1}{2})\\pi")
        tex8 = TexMobject("ix", "=", "i(\\frac{4k+1}{2})\\pi", "+", "\\ln(2\\pm\\sqrt3)")
        self.play(tex7[0].move_to, tex8[0],
                    tex7[1].move_to, tex8[1],
                    tex7[2].move_to, tex8[4],
                    tex7[3].move_to, tex8[3],
                    tex7[4].move_to, tex8[2])
        tex9 = TexMobject("x", "=", "(\\frac{4k+1}{2})\\pi", "-i", "\\ln(2\\pm\\sqrt3)", ",k\\in \\mathbb{Z}").set_color(YELLOW)
